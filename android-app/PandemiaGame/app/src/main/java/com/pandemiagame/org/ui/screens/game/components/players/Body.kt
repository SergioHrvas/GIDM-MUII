...
fun Body(myBody: Boolean, organs: List<Organ>, onOrganSelected: (String) -> Unit = {}) {
    ...
    // 1 = Sí lo tiene
    // 2 = Lo tiene con cura
    // 3 = Lo tiene con cura mágica
    // 4 = Lo tiene protegido
    // -1 = Lo tiene infectado
    // -2 = Lo tiene infectado mágico

    // Calculamos organPlace basado en los organs recibidos
    val organPlace = remember(organs) {
        IntArray(5).apply {
            organs.forEach { organ ->
                when (organ.tipo) {
                    "brain" -> if (organ.cure == 1) this[0] = 2 else if (organ.cure == 2) this[0] =
                        3 else if (organ.cure == 3) this[0] = 4 else if (organ.virus == 1) this[0] =
                        -1 else if (organ.virus == 2) this[0] = -2 else this[0] = 1

                    "heart" -> if (organ.cure == 1) this[1] = 2 else if (organ.cure == 2) this[1] =
                        3 else if (organ.cure == 3) this[1] = 4 else if (organ.virus == 1) this[1] =
                        -1 else if (organ.virus == 2) this[1] = -2 else this[1] = 1

                    "lungs" -> if (organ.cure == 1) this[2] = 2 else if (organ.cure == 2) this[2] =
                        3 else if (organ.cure == 3) this[2] = 4 else if (organ.virus == 1) this[2] =
                        -1 else if (organ.virus == 2) this[2] = -2 else this[2] = 1

                    "intestine" -> if (organ.cure == 1) this[3] =
                        2 else if (organ.cure == 2) this[3] = 3 else if (organ.cure == 3) this[3] =
                        4 else if (organ.virus == 1) this[3] =
                        -1 else if (organ.virus == 2) this[3] = -2 else this[3] = 1
    ...
    Box(
        ...
        Row(
            ...
            Image(
                ...
                contentDescription = stringResource(R.string.cerebro),
            ...
            Image(
                ...
                contentDescription = stringResource(R.string.corazon),
                contentScale = ContentScale.Fit,
                modifier = Modifier
                    .width(if (myBody) 60.dp else 45.dp)
                    .clickable {
            ...
            Image(
                ...
                contentDescription = stringResource(R.string.pulmones),
                contentScale = ContentScale.Fit,
                modifier = Modifier
                    .width(if (myBody) 60.dp else 45.dp)
                    .clickable {
            ...
            Image(
                contentDescription = stringResource(R.string.intestino),
            ...
            Image(
                contentDescription = stringResource(R.string.mágico),
