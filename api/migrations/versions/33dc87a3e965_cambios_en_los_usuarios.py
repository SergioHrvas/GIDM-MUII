...
Revision ID: 33dc87a3e965
Revises: 00df55b1a32b
Create Date: 2025-04-10 16:26:16.974945
...
revision: str = '33dc87a3e965'
down_revision: Union[str, None] = '00df55b1a32b'
...
def upgrade() -> None:
    ...
    op.drop_table('decks', cascade=True)
